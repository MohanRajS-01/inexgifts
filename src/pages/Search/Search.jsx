...
const categoriesData = [
  ...
  { id: 'collage', label: 'Collage Frames', img: '/wooden_collage_frame.png' },
  { id: 'wooden', label: 'Wooden Frames', img: '/wooden_personalized_frame.png' },
  { id: 'led', label: 'LED Frames', img: '/led_frame.png' },
  { id: 'acrylic', label: 'Acrylic Frames', img: '/acrylic_frame.png' },
  { id: 'couple', label: 'Couple Frames', img: '/acrylic_frame.png' },
  { id: 'keychain', label: 'Keychains', img: '/spotify_keychain.png' },
  { id: 'ring', label: 'Promise Rings', img: '/couple_rings.png' },
  { id: 'love', label: 'Love Gifts', img: '/love_gift_box.png' },
  { id: 'mug', label: 'Mugs', img: '/custom_mug.png' },
  { id: 'cushion', label: 'Cushions', img: '/photo_cushion.png' },
  { id: 'bouquet', label: 'Bouquets', img: '/bouquet_flowers.png' },
  { id: 'chocolate', label: 'Chocolates', img: '/chocolate_gift_box.png' },
  { id: 'hamper', label: 'Hampers', img: '/hamper_gift_basket.png' },
  { id: 'teddy', label: 'Teddy Bears', img: '/teddy_bear_plush.png' }
];
  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        borderColor: "rgba(91, 62, 224, 0.15)"
      }}
      layout
