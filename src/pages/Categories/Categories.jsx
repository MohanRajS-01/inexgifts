...
function Categories({ setView, onSearch, selectedCategory, setSelectedCategory }) {
  ...
  const allCategories = [
    { title: 'Gift Boxes', items: '128 items', img: '/Gift.jpg', bgColor: '#F2EAFB', emoji: '🎁', type: 'gifts', rating: 4.8, popularity: 95 },
    { title: 'Photo Frames', items: '96 items', img: '/assets/images/categories/photo_frames.jpg', bgColor: '#FBEAEA', emoji: '🖼️', type: 'decor', rating: 4.6, popularity: 85 },
    ...
    { title: 'LED Lamps', items: '46 items', img: '/assets/images/products/led_photo_lamp.jpg', bgColor: '#FBF4EA', emoji: '💡', type: 'tech', rating: 4.9, popularity: 92 },
    { title: 'Flowers & Bouquets', items: '83 items', img: '/bouquet_flowers.png', bgColor: '#EAFBEF', emoji: '🌹', type: 'gifts', rating: 4.3, popularity: 80 },
    ...
    { title: 'Candles', items: '42 items', img: 'https://images.unsplash.com/photo-1603006905003-be475563bc59?w=200&h=200&fit=crop&crop=center', bgColor: '#FFF4E8', emoji: '🕯️', type: 'decor', rating: 4.6, popularity: 82 },
    ...
    { title: 'Blankets', items: '34 items', img: 'https://images.unsplash.com/photo-1580301762395-21ce84d00bc6?w=200&h=200&fit=crop&crop=center', bgColor: '#F0F5FF', emoji: '🛏️', type: 'home', rating: 4.7, popularity: 79 },
    ...
    { title: 'Smart Gadgets', items: '22 items', img: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200&h=200&fit=crop&crop=center', bgColor: '#EAF0FF', emoji: '⌚', type: 'tech', rating: 4.7, popularity: 87 },
  ...
  return (
    <div className="scrollable-content no-scrollbar pb-10">
      ...
      <div className="popular-list">
        {[
          { title: 'Personalized Gifts', subtitle: 'Make every moment special\nwith a personal touch.', icon: <MdCardGiftcard size={18} color="#5331E5" />, bgColor: '#F7F7FD', img: '/Personalised.jpg', btnColor: '#5331E5' },
          { title: 'For Her', subtitle: 'Thoughtful gifts that celebrate\nher in the most special way.', icon: <MdFavoriteBorder size={18} color="#FF4081" />, bgColor: '#FDF3F7', img: '/Necklace.jpg', btnColor: '#FF4081' },
          { title: 'For Him', subtitle: 'Unique and premium gifts\nhe will absolutely love.', icon: <MdCardGiftcard size={18} color="#448AFF" />, bgColor: '#F2F7FC', img: '/Wooden.jpg', btnColor: '#448AFF' },
          { title: 'For Kids', subtitle: 'Fun, adorable and exciting gifts\nfor your little ones.', icon: <MdFace size={18} color="#4CAF50" />, bgColor: '#F3FBF6', img: '/teddy_bear_plush.png', btnColor: '#4CAF50' },
          ...(expandPopular ? [
            ...
            { title: 'Perfumes', subtitle: 'Luxury fragrances that make\na lasting impression.', icon: <MdFavoriteBorder size={18} color="#E91E63" />, bgColor: '#FDF3F7', img: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=400&h=260&fit=crop&crop=center', btnColor: '#E91E63' },
